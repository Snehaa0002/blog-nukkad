      ...
      <>
        ...
        <div className="relative overflow-hidden">
          ...
          >
            ...
            <div className="bg-gradient-to-tl from-blue-50 via-yellow-100 to-blue-50 blur-3xl w-[90rem] h-[50rem] rounded-fulls origin-top-left -rotate-12 -translate-x-[15rem] dark:from-indigo-900/70 dark:via-indigo-900/70 dark:to-blue-900/70" />
          </div>
          {/* End Gradients */}
