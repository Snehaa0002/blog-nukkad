  ...
  <header className="flex flex-wrap sm:justify-start sm:flex-nowrap w-full bg-gray-800 text-sm py-4 dark:bg-white">
    ...
    >
      <div className="flex items-center justify-between">
        <a
          className="flex-none text-xl font-semibold text-white dark:text-neutral-800"
          href="#"
        >
          Brand
        </a>
      ...
      >
        <div className="flex flex-col gap-5 mt-5 sm:flex-row sm:items-center sm:justify-end sm:mt-0 sm:ps-5">
          ...
          <a
            className="font-medium text-gray-400 hover:text-gray-500 dark:text-neutral-500 dark:hover:text-neutral-400"
            href="#"
          >
            Account
          </a>
